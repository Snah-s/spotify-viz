...
![Parallel Coordinates](parallel.png)

---

## Techniques Used

Mandatory multidimensional techniques:
...
To keep the D3 visualizations responsive, random samples are limited to a maximum of `15000` tracks.

---

## Dataset

The project uses a Spotify dataset from Kaggle.

The dataset includes track-level audio features and metadata such as:
